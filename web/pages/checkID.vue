	...
	<div class="sm:max-w-lg w-full p-10 bg-white rounded-xl z-10">
		<div class="text-center">
			<h2 class="mt-5 text-3xl font-bold text-gray-900">
				Verifier votre Document
			</h2>
			<p class="mt-2 text-sm text-gray-400">verification identite des citoyen et signature des documents</p>
		</div>
        <form class="mt-8 space-y-3" action="#" method="POST">
                    <div class="grid grid-cols-1 space-y-2">
                        <label class="text-sm font-bold text-gray-500 tracking-wide">mettre ici la signature</label>
                            <input class="text-base p-2 border border-gray-300 rounded-lg focus:outline-none focus:border-indigo-500" type="" placeholder="signature">
                    </div>
                    <div class="grid grid-cols-1 space-y-2">
